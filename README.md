...
2. Open my `.jmx` file.
3. Check the **Thread Group** settings.
4. Click the **Start** button.
5. Check the results in **Summary Report**.
6. If I need to check a particular request, I use **View Results Tree**.
...
The goal of this JMeter test plan is to learn performance testing and understand how the **RESTful Booker API** behaves when multiple users send requests at the same time.

I also want to learn how to check:

- Response time
- Throughput
- Error percentage
- Number of concurrent users
- API performance under different loads

This is a beginner-level project, and I plan to improve the test plan as I learn more about **JMeter and performance testing**.
